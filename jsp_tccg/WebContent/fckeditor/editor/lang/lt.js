...
UniversalKeyboard	: "Universali klaviat¨±ra",
PageBreakLbl		: "Puslapi? skirtukas",
...
Done				: "Baigta",
PasteWordConfirm	: "?dedamas tekstas yra pana?us ? kopij? i? Word. Ar J¨±s norite prie? ?d?jim? i?valyti j??",
NotCompatiblePaste	: "?i komanda yra prieinama tik per Internet Explorer 5.5 ar auk?tesn? versij?. Ar J¨±s norite ?terpti be valymo?",
...
NoActiveX			: "J¨±s? nar?ykl?s saugumo nuostatos gali riboti kai kurias redaktoriaus savybes. J¨±s turite aktyvuoti opcij? \"Run ActiveX controls and plug-ins\". Kitu atveju Jums bus prane?ama apie klaidas ir tr¨±kstamas savybes.",
BrowseServerBlocked : "Ne?manoma atidaryti naujo nar?ykl?s lango. ?sitikinkite, kad i?kylan?i? lang? blokavimo programos neveiksnios.",
DialogBlocked		: "Ne?manoma atidaryti dialogo lango. ?sitikinkite, kad i?kylan?i? lang? blokavimo programos neveiksnios.",
...
DlgImgAlignTextTop	: "Teksto vir?¨±n?",
DlgImgAlignTop		: "Vir?¨±n?",
DlgImgPreview		: "Per?i¨±ra",
...
DlgLnkPopStatus		: "B¨±senos juosta",
...
PasteErrorCut	: "J¨±s? nar?ykl?s saugumo nustatymai neleid?ia redaktoriui automati?kai ?vykdyti i?kirpimo operacij?. Tam pra?ome naudoti klaviat¨±r? (Ctrl+X).",
PasteErrorCopy	: "J¨±s? nar?ykl?s saugumo nustatymai neleid?ia redaktoriui automati?kai ?vykdyti kopijavimo operacij?. Tam pra?ome naudoti klaviat¨±r? (Ctrl+C).",

PasteAsText		: "?d?ti kaip gryn? tekst?",
PasteFromWord	: "?d?ti i? Word",

DlgPasteMsg2	: "?emiau esan?iame ?vedimo lauke ?d?kite tekst?, naudodami klaviat¨±r? (<STRONG>Ctrl+V</STRONG>) ir sp¨±stelkite mygtuk? <STRONG>OK</STRONG>.",
...
DlgSpellNoSuggestions	: "- N?ra pasi¨±lym? -",
...
DlgDocMeDescr		: "Dokumento apib¨±dinimas",
DlgDocMeAuthor		: "Autorius",
DlgDocMeCopy		: "Autorin?s teis?s",
DlgDocPreview		: "Per?i¨±ra",
