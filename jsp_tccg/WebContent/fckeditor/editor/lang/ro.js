...
LeftJustify			: "Aliniere la st?nga",
...
PageBreakLbl		: "Separator de pagin? (Page Break)",
PageBreak			: "Insereaz? separator de pagin? (Page Break)",

Form			: "Formular (Form)",
Checkbox		: "Bif? (Checkbox)",
RadioButton		: "Buton radio (RadioButton)",
TextField		: "C?mp text (TextField)",
Textarea		: "Suprafa?? text (Textarea)",
HiddenField		: "C?mp ascuns (HiddenField)",
Button			: "Buton",
SelectionField	: "C?mp selec?ie (SelectionField)",
ImageButton		: "Buton imagine (ImageButton)",

FitWindow		: "Maximizeaz? m?rimea editorului",
...
RowCM				: "Linie",
ColumnCM			: "Coloan?",
InsertRowAfter		: "Insereaz? linie dup?",
InsertRowBefore		: "Insereaz? linie ?nainte",
DeleteRows			: "?terge linii",
InsertColumnAfter	: "Insereaz? coloan? dup?",
InsertColumnBefore	: "Insereaz? coloan? ?nainte",
DeleteColumns		: "?terge celule",
InsertCellAfter		: "Insereaz? celul? dup?",
InsertCellBefore	: "Insereaz? celul? ?nainte",
DeleteCells			: "?terge celule",
MergeCells			: "Une?te celule",
MergeRight			: "Une?te la dreapta",
MergeDown			: "Une?te jos",
HorizontalSplitCell	: "?mparte celula pe orizontal?",
VerticalSplitCell	: "?mparte celula pe vertical?",
TableDelete			: "?terge tabel",
...
HiddenFieldProp		: "Propriet??i c?mp ascuns (Hidden Field)",
RadioButtonProp		: "Propriet??i buton radio (Radio Button)",
ImageButtonProp		: "Propriet??i buton imagine (Image Button)",
TextFieldProp		: "Propriet??i c?mp text (Text Field)",
SelectionFieldProp	: "Propriet??i c?mp selec?ie (Selection Field)",
...
NoActiveX			: "Set?rile de securitate ale programului dvs. cu care naviga?i pe internet (browser) pot limita anumite func?ionalit??i ale editorului. Pentru a evita asta, trebuie s? activa?i op?iunea \"Run ActiveX controls and plug-ins\". Poate ve?i ?nt?lni erori sau ve?i observa func?ionalit??i lips?.",
BrowseServerBlocked : "The resources browser could not be opened. Asigura?i-v? c? nu e activ niciun \"popup blocker\" (func?ionalitate a programului de navigat (browser) sau a unui plug-in al acestuia de a bloca deschiderea unui noi ferestre).",
DialogBlocked		: "Nu a fost posibil? deschiderea unei ferestre de dialog. Asigura?i-v? c? nu e activ niciun \"popup blocker\" (func?ionalitate a programului de navigat (browser) sau a unui plug-in al acestuia de a bloca deschiderea unui noi ferestre).",
...
DlgGenLangDirLtr	: "st?nga-dreapta (LTR)",
DlgGenLangDirRtl	: "dreapta-st?nga (RTL)",
...
DlgLnkNoAnchors		: "(Nicio ancor? disponibil? ?n document)",
...
DlgLnkPopLeft		: "Pozi?ia la st?nga",
...
DlnLnkMsgInvPopName	: "Numele 'popup'-ului trebuie s? ?nceap? cu un caracter alfabetic ?i trebuie s? nu con?in? spa?ii",
...
DlgFindAndReplaceTitle	: "G?se?te ?i ?nlocuie?te",
...
DlgPasteSec		: "Din cauza set?rilor de securitate ale programului dvs. cu care naviga?i pe internet (browser), editorul nu poate accesa direct datele din clipboard. Va trebui s? ad?uga?i din nou datele ?n aceast? fereastr?.",
...
DlgSpellNoMispell		: "Verificarea textului terminat?: Nicio gre?eal? g?sit?",
DlgSpellNoChanges		: "Verificarea textului terminat?: Niciun cuv?nt modificat",
DlgSpellOneChange		: "Verificarea textului terminat?: Un cuv?nt modificat",
...
DlgDocLangDirLTR	: "st?nga-dreapta (LTR)",
DlgDocLangDirRTL	: "dreapta-st?nga (RTL)",
DlgDocLangCode		: "Codul limbii",
DlgDocCharSet		: "Encoding setului de caractere",
DlgDocCharSetCE		: "Central european",
DlgDocCharSetCT		: "Chinezesc tradi?ional (Big5)",
...
DlgTemplatesNoTpl	: "(Niciun template (?ablon) definit)",
DlgTemplatesReplace	: "?nlocuie?te cuprinsul actual",

// About Dialog
DlgAboutAboutTab	: "Despre",
DlgAboutBrowserInfoTab	: "Informa?ii browser",
DlgAboutLicenseTab	: "Licen??",
