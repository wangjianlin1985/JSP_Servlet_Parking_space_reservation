...
Copy				: "Kopiraj",
Paste				: "Zalijepi",
PasteText			: "Zalijepi kao obi¨¨an tekst",
...
// Alerts and Messages
ProcessingXHTML		: "Procesiram XHTML. Molim sa¨¨ekajte...",
Done				: "Gotovo",
PasteWordConfirm	: "Tekst koji ?elite zalijepiti ¨¨ini se da je kopiran iz Worda. Da li ?elite da se prvo o¨¨isti?",
NotCompatiblePaste	: "Ova komanda je podr?ana u Internet Explorer-u verzijama 5.5 ili novijim. Da li ?elite da izvr?ite lijepljenje teksta bez ¨¨i??enja?",
...
DlgGenLangCode		: "Jezi¨¨ni k?d",
DlgGenAccessKey		: "Pristupna tipka",
DlgGenName			: "Naziv",
DlgGenTabIndex		: "Tab indeks",
DlgGenLongDescr		: "Duga¨¨ki opis URL-a",
...
DlgReplaceFindLbl		: "Na?i ?ta:",
DlgReplaceReplaceLbl	: "Zamjeni sa:",
DlgReplaceCaseChk		: "Upore?uj velika/mala slova",
DlgReplaceReplaceBtn	: "Zamjeni",
DlgReplaceReplAllBtn	: "Zamjeni sve",
DlgReplaceWordChk		: "Upore?uj samo cijelu rije¨¨",

// Paste Operations / Dialog
PasteErrorCut	: "Sigurnosne postavke va?eg pretra?iva¨¨a ne dozvoljavaju operacije automatskog rezanja. Molimo koristite kraticu na tastaturi (Ctrl+X).",
PasteErrorCopy	: "Sigurnosne postavke Va?eg pretra?iva¨¨a ne dozvoljavaju operacije automatskog kopiranja. Molimo koristite kraticu na tastaturi (Ctrl+C).",

PasteAsText		: "Zalijepi kao obi¨¨an tekst",
