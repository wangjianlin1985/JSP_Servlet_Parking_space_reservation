 ...
 * == END LICENSE ==
 *
 * Norwegian Bokm?l language file.
 */
...
FitWindow		: "Maksimer st?rrelsen p? redigeringsverkt?yet",
...
TextareaProp		: "Egenskaper for tekstomr?de",
...
Done				: "Ferdig",
PasteWordConfirm	: "Teksten du pr?ver ? lime inn ser ut som om den kommer fra Word. Vil du rense den for un?dvendig kode f?r du limer inn?",
NotCompatiblePaste	: "Denne kommandoen er kun tilgjenglig for Internet Explorer versjon 5.5 eller bedre. Vil du fortsette uten ? rense? (Du kan lime inn som ren tekst)",
...
NoActiveX			: "Din nettlesers sikkerhetsinstillinger kan begrense noen av funksjonene i redigeringsverkt?yet. Du m? aktivere \"Kj?r ActiveX-kontroller og plugin-modeller\". Du kan oppleve feil og advarsler om manglende funksjoner",
BrowseServerBlocked : "Kunne ikke ?pne dialogboksen for filarkiv. Sjekk at popup-blokkering er deaktivert.",
DialogBlocked		: "Kunne ikke ?pne dialogboksen. Sjekk at popup-blokkering er deaktivert.",
VisitLinkBlocked	: "Kunne ikke ?pne et nytt vindu. Sjekk at popup-blokkering er deaktivert.",
...
DlgFlashScaleFit	: "Skaler til ? passe",
...
DlgLnkPopWinName	: "Navn p? popup-vindus",
...
DlgFindAndReplaceTitle	: "S?k og erstatt",

// Find Dialog
DlgFindTitle		: "S?k",
DlgFindFindBtn		: "S?k",
DlgFindNotFoundMsg	: "Fant ikke s?keteksten.",

// Replace Dialog
DlgReplaceTitle			: "Erstatt",
DlgReplaceFindLbl		: "S?k etter:",
DlgReplaceReplaceLbl	: "Erstatt med:",
DlgReplaceCaseChk		: "Skill mellom store og sm? bokstaver",
...
DlgPasteSec		: "Din nettlesers sikkerhetsinstillinger gir ikke redigeringsverkt?yet direkte tilgang til utklippstavlen. Du m? lime det igjen i dette vinduet.",
...
IeSpellDownload			: "Stavekontroll er ikke installert. Vil du laste den ned n??",
...
DlgDocBgNoScroll	: "L?s bakgrunnsbilde",
DlgDocCText			: "Tekst",
DlgDocCLink			: "Link",
