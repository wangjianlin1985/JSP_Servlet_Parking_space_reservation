...
PasteWord			: "Coller en tant que Word (format¨¦)",
Print				: "Imprimer",
...
InsertSmiley		: "Ins¨¦rer un Emoticon",
...
Button			: "Bouton",
SelectionField	: "Champ de s¨¦lection",
...
FontFormats			: "Normal;Format¨¦;Adresse;En-t¨ºte 1;En-t¨ºte 2;En-t¨ºte 3;En-t¨ºte 4;En-t¨ºte 5;En-t¨ºte 6;Normal (DIV)",
...
NotCompatiblePaste	: "Cette commande n¨¦cessite Internet Explorer version 5.5 et plus. Souhaitez-vous coller sans nettoyage?",
UnknownToolbarItem	: "?l¨¦ment de barre d'outil inconnu \"%1\"",
...
BrowseServerBlocked : "Le navigateur n'a pas pu ¨ºtre ouvert. Assurez-vous que les bloqueurs de popups soient d¨¦sactiv¨¦s.",
DialogBlocked		: "La fen¨ºtre de dialogue n'a pas pu s'ouvrir. Assurez-vous que les bloqueurs de popups soient d¨¦sactiv¨¦s.",
...
DlgGenAccessKey		: "?quivalent clavier",
DlgGenName			: "Nom",
...
DlgLnkTargetPopup	: "<fen¨ºtre popup>",
DlgLnkTargetBlank	: "Nouvelle fen¨ºtre (_blank)",
DlgLnkTargetParent	: "Fen¨ºtre m¨¨re (_parent)",
DlgLnkTargetSelf	: "M¨ºme fen¨ºtre (_self)",
DlgLnkTargetTop		: "Fen¨ºtre sup¨¦rieure (_top)",
DlgLnkTargetFrameName	: "Nom du cadre de destination",
DlgLnkPopWinName	: "Nom de la fen¨ºtre popup",
DlgLnkPopWinFeat	: "Caract¨¦ristiques de la fen¨ºtre popup",
...
DlnLnkMsgInvPopName	: "Le nom de la fen¨ºtre popup doit commencer par une lettre et ne doit pas contenir d'espace",
...
// Smiley Dialog
DlgSmileyTitle		: "Ins¨¦rer un Emoticon",
...
PasteErrorCut	: "Les param¨¨tres de s¨¦curit¨¦ de votre navigateur emp¨ºchent l'¨¦diteur de couper automatiquement vos donn¨¦es. Veuillez utiliser les ¨¦quivalents claviers (Ctrl+X).",
PasteErrorCopy	: "Les param¨¨tres de s¨¦curit¨¦ de votre navigateur emp¨ºchent l'¨¦diteur de copier automatiquement vos donn¨¦es. Veuillez utiliser les ¨¦quivalents claviers (Ctrl+C).",
...
DlgPasteSec		: "A cause des param¨¨tres de s¨¦curit¨¦ de votre navigateur, l'¨¦diteur ne peut acc¨¦der au presse-papier directement. Vous devez coller ¨¤ nouveau le contenu dans cette fen¨ºtre.",
...
DlgSpellNoMispell		: "V¨¦rification d'orthographe termin¨¦e: pas d'erreur trouv¨¦e",
...
IeSpellDownload			: "Le Correcteur d'orthographe n'est pas install¨¦. Souhaitez-vous le t¨¦l¨¦charger maintenant?",
...
DlgTemplatesSelMsg	: "S¨¦lectionner le mod¨¨le ¨¤ ouvrir dans l'¨¦diteur<br>(le contenu actuel sera remplac¨¦):",
